...
contract nftsIPFS {
    address payable contractOwner = payable(0x968a2FaD77a7884613F0935e2665948E20908Ced);
    ...
    // Get the details of the individual Image(post)
    ...
    function withdraw(address _owner) external {
        require(_owner == contractOwner, "only Contract owner can withdraw");
